...
> **CLI sederhana untuk mencari dan mengurutkan data inheritance di game *Umamusume: Pretty Derby*.**
...
> Setelah itu, kamu bisa langsung pakai perintah `link-cli` di terminal tanpa perlu masuk ke folder proyek.
